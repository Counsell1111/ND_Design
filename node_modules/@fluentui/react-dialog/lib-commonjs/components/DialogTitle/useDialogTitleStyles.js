...
const useDialogTitleInternalStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".fdiulkx[data-fui-focus-visible]::after{top:-2px;}",
        ".f1yalx80[data-fui-focus-visible]::after{bottom:-2px;}",
        ".fq22d5a[data-fui-focus-visible]::after{left:-2px;}",
        ".f1jw7pan[data-fui-focus-visible]::after{right:-2px;}"
    ],
    f: [
...
const useDialogTitleStyles_unstable = (state)=>{
    ...
    state.root.className = (0, _react.mergeClasses)(dialogTitleClassNames.root, styles.root, !state.action && styles.rootWithoutCloseButton, state.root.className);
    if (state.action) {
